    ...
    <MainLayout>
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between gap-4 py-4 px-4 backdrop-blur-lg">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">AI Roadmap</h1>
        </div>
      </header>
      ...
      <div className="pb-32 px-8 pt-8">
        {!skillId ? (
          <div className="flex flex-col items-center justify-center py-20 text-center px-6 animate-in fade-in zoom-in duration-500">
            ...
            <Link
              to="/search"
              className="w-full max-w-sm flex items-center justify-center gap-2 py-4 rounded-2xl bg-primary text-white font-black text-sm shadow-xl shadow-primary/30 hover:shadow-primary/40 active:scale-95 transition-all"
            >
          ...
          <div className="w-full">
            <div className="mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-black tracking-tight leading-tight text-slate-900 dark:text-white">
